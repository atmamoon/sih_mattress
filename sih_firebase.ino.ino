...
#define FIREBASE_HOST "https://warm-patient-matress.firebaseio.com/"                          // the project name address from firebase id
#define FIREBASE_AUTH "VIcgq6DtGo90vAS1GfFL6LhEuJkftd1jCcqBYQav"            // the secret key generated from firebase
